...
def create_standard_sens(directory, objecto, iraf_name, iraf_directory = 'iidscal', suffix = ''):
    ...
    standard(input       = standard_file,             # Input name of the image
             ...
             #extinction  = '/opt/iraf/iraf/noao/lib/onedstds/%s/%s.dat'%(iraf_directory, iraf_name), # Extinction file
             #caldir      = '/opt/iraf/iraf/noao/lib/onedstds/%s/'%iraf_directory,                    # Directory containing calibration data
