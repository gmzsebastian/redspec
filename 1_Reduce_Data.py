...
def iraf_ccdproc(directory, file_type, bias_file, flat_file = '', extension = '', fixpix = False, fixfile = ''):
    '''
    ...
    ccdproc(images      = images_in,   # List of CCD images to correct
            ...
            fixfile     = fixfile,     # File describing the bad lines and columns
...
def individual_flats(directory, objecto, bias_file = 'bias/Bias.fits', response_sample = '10:2670', fit_order = 20, extension = '', fixpix = False, fixfile = ''):
    '''
...
def reduce_data(directory, objecto, do_individual_flats = True, bias_file = 'bias/Bias.fits', flat_file = '', arc_name = 'arc', flat_name = 'flat', extension = '', gain_name = 'GAIN', noise_name = 'enoise', fixpix = False, fixfile = ''):
    ...
    if do_individual_flats:
        ...
        # Bias and Flat correct the science and lamps
        iraf_ccdproc(directory, objecto,  bias_file = bias_file, flat_file = flat_file, extension = extension, fixpix = fixpix, fixfile = fixfile)
        iraf_ccdproc(directory, arc_name, bias_file = bias_file, flat_file = flat_file, extension = extension, fixpix = fixpix, fixfile = fixfile)
