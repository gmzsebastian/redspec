...
def wavelength_solution(directory, objecto, cenwave, pix_scale,
                        max_wave=9999999, min_wave=0, width_guess=4, upper_sigma=2.0, lower_sigma=2.0, order=3, max_delta=10, fit_range=9, max_width=5, arc_name='arc'):
    '''
...
def test_solution(directory, objecto, cenwave, pix_scale, bright_lines,
                  width_guess=4, max_delta=10, fit_range=9, max_width=5,
                  arc_name='HeNeAr'):
    '''
...
for obj in center_obj:
    best_cenwave, best_pix_scale = test_solution(args.input_dir + '/' + obj,
                                                 ...
                                                 center_cen,
                                                 center_scale,
                                                 bright_lines=center_lines, arc_name='arc')
